/*
  ...
  - You are about to drop the column `assigned_sales_rep_id` on the `customers` table. All the data in the column will be lost.

*/
-- DropForeignKey
ALTER TABLE "customers" DROP CONSTRAINT "Customer_assigned_sales_rep_id_fkey";
...
-- AlterTable
ALTER TABLE "customers" DROP COLUMN "assigned_sales_rep_id";
