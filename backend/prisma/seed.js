...
const ALL_PERMISSIONS = [
  ...
  { name: 'brands:create', module: 'brands', action: 'create', description: 'Create brands' },
  { name: 'brands:read', module: 'brands', action: 'read', description: 'Read brands' },
  { name: 'brands:update', module: 'brands', action: 'update', description: 'Update brands' },
  { name: 'brands:delete', module: 'brands', action: 'delete', description: 'Delete brands' },
  { name: 'units:create', module: 'units', action: 'create', description: 'Create units' },
  { name: 'units:read', module: 'units', action: 'read', description: 'Read units' },
  { name: 'units:update', module: 'units', action: 'update', description: 'Update units' },
  { name: 'units:delete', module: 'units', action: 'delete', description: 'Delete units' },
