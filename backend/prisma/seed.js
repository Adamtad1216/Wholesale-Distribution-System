...
export const ALL_PERMISSIONS = [
  ...
  { name: "credits:read_all", module: "finance", action: "read_all", description: "View all credits across the system" },
  ...
  { name: "payment-terms:read_all", module: "finance", action: "read_all", description: "View all payment terms" },
