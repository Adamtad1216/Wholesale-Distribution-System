 ...
 */
router.put('/providers/:id', requirePermission(['payment-options:update', 'payment-options:manage', 'payment-option:manage', 'payments:update']), (req, res) => paymentController.updateProvider(req, res));
router.delete('/providers/:id', requirePermission(['payment-options:delete', 'payment-options:manage', 'payment-option:manage', 'payments:delete']), (req, res) => paymentController.deleteProvider(req, res));
 ...
 */
router.post('/providers/:providerId/methods', requirePermission(['payment-options:create', 'payment-options:manage', 'payment-option:manage', 'payments:create']), (req, res) => paymentController.createMethodOption(req, res));
 ...
 */
router.put('/methods/:id', requirePermission(['payment-options:update', 'payment-options:manage', 'payment-option:manage', 'payments:update']), (req, res) => paymentController.updateMethodOption(req, res));
router.delete('/methods/:id', requirePermission(['payment-options:delete', 'payment-options:manage', 'payment-option:manage', 'payments:delete']), (req, res) => paymentController.deleteMethodOption(req, res));
