  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="bg-card/60 border border-border rounded-lg p-12 text-center text-muted-foreground">
          <h4 className="text-base font-normal text-foreground">No Categories Found</h4>
          <p className="text-xs mt-1">Create categories to organize products in the catalog.</p>
        </div>
      ) : (
        <Table>
          <TableHeader>
          ...
          <TableBody>
            {filteredCategories.map((cat) => {
              ...
              return (
                <TableRow key={cat.id}>
                  <TableCell>
                    <span className="font-normal text-foreground">{cat.name}</span>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <span className="text-xs text-muted-foreground">
                      {parent ? parent.name : 'Top Level (None)'}
                    </span>
                  </TableCell>
                  <TableCell>
                    <span
      ...
      <Modal
        ...
        subtitle="Specify category details to classify products"
        icon="📁"
        maxWidth="max-w-md"
        scope="workspace"
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <span className="text-[11px] text-muted-foreground mt-1 block">
              Leave blank to create a Top-Level Root Category, or select an existing parent to nest under.
            </span>
          </div>
      ...
      <ConfirmDeleteModal
        ...
        title="Delete Category"
        message={`Are you sure you want to delete category "${deleteTarget?.name}"? Items linked to this category may need reassigning.`}
        submitting={deleting}
      />
    </div>
  );
