...
export default function ProfileHeader({ user, role, personData, joinedDate, getInitials, onAvatarUpload }) {
  ...
  return (
    <Card noPadding className="overflow-hidden border border-border ">
      ...
      <div className="px-6 pb-6 pt-0 relative flex flex-col md:flex-row items-center md:items-end justify-between gap-6 -mt-14 sm:-mt-16">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-end gap-5 text-center sm:text-left">
          ...
          <div className="relative group shrink-0">
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-card text-blue-600 font-bold text-2xl sm:text-3xl flex items-center justify-center shadow-xl ring-4 ring-emerald-500 overflow-hidden">
              {avatarUrl ? (
            ...
            <button
              ...
              className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-blue-600 hover:bg-blue-700  flex items-center justify-center shadow-lg ring-2 ring-white transition-transform hover:scale-110 cursor-pointer"
            >
        ...
        <div className="text-center md:text-right shrink-0 pb-1">
          ...
          <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-emerald-100 text-emerald-800   border border-emerald-300  mt-1">
