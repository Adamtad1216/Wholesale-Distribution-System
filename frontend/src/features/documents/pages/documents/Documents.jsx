...
export default function Documents() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-100 light:text-slate-900">Document Vault</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-1 space-y-4">
          ...
          <div className="border-2 border-dashed border-slate-700 hover:border-violet-500 rounded-lg p-8 text-center cursor-pointer transition">
            <span className="text-3xl block mb-2">☁️</span>
            <span className="text-xs text-slate-400 block">Click or Drag invoice to upload</span>
            <span className="text-[10px] text-slate-400 block mt-1">PDF, JPG, PNG (Max 10MB)</span>
          </div>
