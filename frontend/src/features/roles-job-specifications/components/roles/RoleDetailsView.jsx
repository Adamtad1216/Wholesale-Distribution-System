    ...
    <div className="w-full px-6 py-6 space-y-6">
      ...
      {activeSubTab === 'PERMISSIONS' && (
        <div className="space-y-4">
          {isWildcard && (
            <Card className="p-4 bg-violet-500/10 dark:bg-violet-950/40 border border-violet-500/30 rounded-xl flex items-start gap-3 shadow-sm">
              <div className="p-2 bg-violet-500/20 text-violet-600 dark:text-violet-400 rounded-lg shrink-0">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div>
                <h4 className="text-sm font-bold text-violet-700 dark:text-violet-300">Unrestricted Super Admin Access (`*`)</h4>
