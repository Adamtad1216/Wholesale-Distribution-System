    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-3 rounded-xl bg-muted900/40 border border-border text-xs">
          <span className="text-muted-foreground font-normal">Approval Status:</span>
          {transfer.status === 'PENDING' ? (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-normal bg-amber-500/15 text-amber-300 border border-amber-500/30">
              <Clock className="w-3.5 h-3.5" />
              <span>Pending Authorization</span>
            </span>
          ) : transfer.status === 'APPROVED' ? (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-normal bg-emerald-500/15 text-emerald-300 border border-emerald-500/30">
              <CheckCircle2 className="w-3.5 h-3.5" />
              <span>Approved & Executed</span>
            </span>
          ) : (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-normal bg-rose-500/15 text-rose-300 border border-rose-500/30">
        ...
        <div className="p-4 rounded-2xl bg-gradient-to-r from-sky-500/10 via-indigo-500/10 to-violet-500/10 border border-sky-500/20 flex items-center justify-between gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 font-normal text-foreground truncate">
          ...
          <div className="flex-1 min-w-0 text-right">
            ...
            <div className="flex items-center justify-end gap-1.5 font-normal text-foreground truncate">
        ...
        {transfer.rejectionReason && (
          <div className="p-3 rounded-xl bg-rose-500/10 border border-rose-500/30 text-xs text-rose-300 space-y-1">
            <span className="text-[10px] uppercase font-normal text-rose-400 block">
              Rejection Reason
            </span>
        ...
        {transfer.remark && (
          <div className="p-3 rounded-xl bg-card border border-border/80 text-xs">
            <span className="text-[10px] text-muted-foreground uppercase font-normal block mb-1 flex items-center gap-1">
