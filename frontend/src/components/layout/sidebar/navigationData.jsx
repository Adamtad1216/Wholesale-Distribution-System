  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: 'Finance',
        href: '/finance',
        permission: ['payments:read', 'payments:read_all', 'invoices:read', 'invoices:read_all', 'credits:read', 'credits:read_all', 'payment-terms:read', 'payment-terms:read_all'],
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      },
      {
        name: 'Procurement',
        href: '/procurement',
        permission: ['purchase-orders:read', 'goods-receipts:read', 'procurement:read'],
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      },
      {
        name: 'Pricing & Quotas',
        href: '/pricing/tiers',
        permission: ['PRICE_TIER_VIEW', 'PRODUCT_PRICE_VIEW', 'DISCOUNT_VIEW', 'QUOTA_VIEW'],
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const customerNavigationSections = [
  {
    title: 'OVERVIEW',
    items: [
      {
...
export const salesRepNavigationSections = [
  {
    title: 'SALES COMMAND',
    items: [
      {
...
export const warehouseManagerNavigationSections = [
  {
  ...
  {
    title: 'FACILITIES & FLEET',
    items: [
      {
        name: 'Branches & Facilities',
        href: '/branches',
        permission: 'branches:read',
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const storeKeeperNavigationSections = [
  {
    title: 'STORE COMMAND',
    items: [
      {
...
export const driverNavigationSections = [
  {
