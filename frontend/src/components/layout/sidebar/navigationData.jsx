    ...
    items: [
      {
        name: 'Sales Orders',
        href: '/sales-orders',
        permission: ['sales_orders:read', 'sales-orders:read', 'orders:read'],
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      },
      {
        ...
        permission: ['sales_orders:create', 'sales-orders:create', 'orders:create'],
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const customerNavigationSections = navigationSections;
export const salesRepNavigationSections = navigationSections;
export const warehouseManagerNavigationSections = navigationSections;
export const storeKeeperNavigationSections = navigationSections;
export const driverNavigationSections = navigationSections;
